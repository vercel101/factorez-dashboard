...
import { getAllSaleInvoiceApi } from "../../../../apis/adminApis";
import { ImFilePdf } from "react-icons/im";

const SaleInvoice = ({ tokenReducer }) => {
                            ...
                            invData.map((el, i) => (
                                <tr key={el._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td className="px-6 py-3">
                                        <button className="inline-flex items-center py-1 px-2 rounded space-x-3 border bg-slate-100 dark:bg-slate-500 dark:border-gray-700 text-red-400">
                                            <ImFilePdf size={20} />
                                            <span>Download</span>
                                        </button>
                                    </td>
