...
import {getAllVentorApi, verifyVendorApi} from "../../../../apis/adminApis";
...
function AllVendors({tokenReducer}) {
    ...
    const updateVendor = async (data, id) => {
        ...
        await verifyVendorApi(data, tokenReducer,id).then(res => {
            console.log(res.data);
    ...
    const updatedTable = () => {
        return allVendors.map((el, i) => (
            <tr key={el._id} className="border-b dark:border-neutral-500">
                ...
                <td className="whitespace-nowrap border-r px-6 py-2 dark:border-neutral-500 border">
                    {el.vendor_unique_id}
                </td>
                ...
                <td className="whitespace-nowrap border-r px-6 py-2 dark:border-neutral-500">
                    {el.actionTakenBy ? el.actionTakenBy.name : "NoAction"}
                </td>
                <td className="whitespace-nowrap border-r px-6 py-2 dark:border-neutral-500">
                    {el.status}
                </td>
    ...
    return (
        <div className=" p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            {
                activeTableModel.flag && <TableActionModel changeHandler={viewHandleChange} save={updateVendor} details={activeTableModel.data}  actionClose={() => setActiveTableModel({data: null, flag: false})}/>
            }
            ...
            <div className="flex justify-start items-center text-sm">
                <select
                    name=""
                    id=""
                    className="outline-none bg-white dark:bg-teal-800 px-3 py-1 rounded-s-full border"
                >
                ...
                <select
                    name=""
                    id=""
                    className="outline-none bg-white px-3 py-1 dark:bg-teal-800 border border-s-0"
                >
                ...
                <select
                    name=""
                    id=""
                    className="outline-none bg-white px-3 py-1 border dark:bg-teal-800 border-s-0 rounded-e-full"
                >
                    <option value="">Test vendor 1</option>
                    <option value="">Test vendor 2</option>
                    <option value="">Test vendor 3</option>
                ...
                <div
                    className="w-[300px] ms-5 rounded-full bg-white dark:bg-teal-800 border flex justify-between items-center">
                    <input
                        type="search"
                        placeholder="Search..."
                        className="outline-none mx-3 w-full text-base"
                    />
                ...
                <div className="flex flex-col">
                            ...
                            <div className="">
                                <table
                                    ...
                                    <tr>
                                        <th
                                            scope="col"
                                            className="border-r w-1 p-3 dark:border-neutral-500 "
                                        >
                                            <input
                                                type="checkbox"
                                                name=""
                                    ...
                                    <tbody>
                                    {allVendors.length > 0 && updatedTable()}
                                    </tbody>
                                </table>
                            </div>
                        </div>
                    ...
                    <div className="mt-5 flex justify-between items-center">
                        <div className="flex items-center">
                            ...
                            <button
                                type="text"
                                className="h-12 w-12 dark:bg-teal-500 bg-teal-200 text-center"
                            >
                                Go!
                            </button>
                        </div>
