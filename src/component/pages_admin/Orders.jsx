...
const Orders = () => {
    const { sidebarCollapse, userInfoReducer, tokenReducer } = useSelector((state) => state);
    return (
        <div
            className={`${
            ...
            <div className="px-3 py-1">
                <Tabs>
                    ...
                    <TabPanel className="mt-5">
                        <AllOrders userInfoReducer={userInfoReducer} tokenReducer={tokenReducer}/>
                    </TabPanel>
                    <TabPanel className="mt-5">
                        <CancelledOrder userInfoReducer={userInfoReducer} tokenReducer={tokenReducer}/>
                    </TabPanel>
                    {userInfoReducer.role && isRoleExists(userInfoReducer.role, ["ADMIN"]) && (
                        <TabPanel className="mt-5">
